...
MACRO_CONFIG_INT(ClVanillaSkinsOnly, cl_vanilla_skins_only, 1, 0, 1, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Only show skins available in Vanilla Teeworlds")
...
MACRO_CONFIG_INT(UiScale, ui_scale, 110, 50, 150, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Interface scale")
